...
tipoProceso.addEventListener('change', function () {
    ...
    switch (valor) {
        case '1': // Diseño textil
            ...
            procesos.innerHTML += '<li><input class="form-check-input" type="checkbox" onclick="checkbox(this)" id="enrrollado" name="enrrollado" checked><label id="enrrolladoLabel" for="enrrollado"> Enrollado</label></li>';
